@extends('templates.app', ['title' => 'PEKU.ID'])
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('income.add.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis" id="jenis" class="form-control">
                            ...
                            <option value="pasif" {{ old('type') == 'aktif' ? 'selected' : ' ' }}>pasif</option>
                            <option value="aktif" {{ old('type') == 'pasif' ? 'selected' : '' }}>aktif</option>
                        </select>
                    </div>
